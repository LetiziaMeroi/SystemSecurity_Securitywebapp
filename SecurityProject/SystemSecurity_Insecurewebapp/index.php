...
<html>
	...
	<div style=" text-align: center;" class="content">
		<h2>Insecure Homepage</h2>
		<br><br>
		<!-- logged in user information -->
		<?php  if (isset($_SESSION['username'])) : ?>
			<p>Welcome <strong><?php echo $_SESSION['username']; ?></strong></p> <!-- si può fare un attacco -->
			<p> <a href="../SystemSecurity_Insecurewebapp/index.php?logout='1'" style="color: red;">logout</a> </p>
			<a href="../SystemSecurity_Insecurewebapp/question.php" class="btn btn-primary">Ask a question</a>
			<?php else:?>
				<a href="../SystemSecurity_Insecurewebapp/login.php" class="btn btn-primary">LOGIN</a>
		<?php endif ?>
